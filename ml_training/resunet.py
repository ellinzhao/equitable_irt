...
class Upsample(nn.Module):
    def __init__(self, input_dim, output_dim, kernel, stride):
        ...
        self.upsample = nn.Upsample(mode='bilinear', scale_factor=stride, align_corners=True)
...
class ResUNet(nn.Module):
    def __init__(self, in_ch=1, out_ch=2, ch_mult=8):
        super(ResUNet, self).__init__()

        filters = [ch_mult * i for i in [1, 2, 4, 8]]
